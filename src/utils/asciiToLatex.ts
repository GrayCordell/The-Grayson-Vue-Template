 ...
 * The original code that this was based on was released under the MIT license. at https://github.com/asciimath/asciimathml/blob/master/asciimath-based/ASCIIMathTeXImg.js
 * which was based on ASCIIMathML, Version 1.4.7 Aug 30, 2005, (c) Peter Jipsen http://www.chapman.edu/~jipsen
...
let AMpreviousSymbol: number
let AMcurrentSymbol: number
...
export function AMTparseAMtoTeX(str: string) {
  AMnestingDepth = 0
  str = str.replace(/(&nbsp;|\u00A0|&#160;)/g, '')
  str = str.replace(/&gt;/g, '>')
  str = str.replace(/&lt;/g, '<')
...
// better name
export const parseASCIIToLatex = AMTparseAMtoTeX
